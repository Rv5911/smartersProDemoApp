...
function Navbar() {
    ...
    <div class="navbar-container">
      <div class="navbar-left">
        <img src="/assets/app-logo.webp" alt="Logo" class="navbar-logo" />
        ...
        <div id="main-sidebar-section" class="sidebar-section active">
          <div class="sidebar-header">
            <div class="sidebar-user-info">
              <span>${JSON.parse(localStorage.getItem("selectedPlaylist")) ? JSON.parse(localStorage.getItem("selectedPlaylist")).playlistName : ""}</span>
            </div>
