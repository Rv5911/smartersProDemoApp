        ...
        window.livePlayer = {
          ...
          isFullscreen() {
            try {
              ...
              return !!(
                wrapperEl && wrapperEl.classList.contains("fullscreen-mode")
              );
            } catch {
              return false;
            }
          ...
          requestFullscreen() {
            try {
              ...
              if (wrapperEl) wrapperEl.classList.add("fullscreen-mode");
            } catch {}
          },
          exitFullscreen() {
            try {
              ...
              if (wrapperEl) wrapperEl.classList.remove("fullscreen-mode");
            } catch {}
          },
          on(ev, handler) {
            try {
