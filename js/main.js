window.onload = function () {
  ...
  window.navigateToStartingPage = function () {
    if (window.splashTransitioned) return;
    window.splashTransitioned = true;

    // Clear splash video from DOM
...
function showSplashScreen() {
  ...
  if (video) {
    video.onended = function () {
      if (typeof window.navigateToStartingPage === "function") {
        window.navigateToStartingPage();
      }
    };
